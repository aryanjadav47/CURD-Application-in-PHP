...
<body>
    ...
    <p class="mx-auto -mt-4 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">Welcome to
        <span class="border-b border-dotted border-slate-300">CURD</span>
    </p>

    <h1 class="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        <span class="inline-block">CURD 
            ...
            <span class="relative">Application </span></span>
        </span>
        <span class="inline-block">in PHP</span>
    </h1>
